...
<nav id="topMenu">
  <ul>
    ...
    <li<?php echo ($pageName === 'out')?' class="current"':'';?>><a class="menuLink" href="http://1.221.118.86/sellmanage/order/out.php"><img src="http://1.221.118.86/sellmanage/img/<?php echo ($pageName === 'out')?'menubox3_blue.jpg':'menubox3.jpg';?>" /></a></li>
    <li<?php echo ($pageName === 'in')?' class="current"':'';?>><a class="menuLink" href="http://1.221.118.86/sellmanage/order/in.php"><img src="http://1.221.118.86/sellmanage/img/<?php echo ($pageName === 'in')?'menubox4_blue.jpg':'menubox4.jpg';?>" /></a></li>
