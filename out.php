...
function renumbering(){
	$( ".renumber_wrap" ).each(function(e){// tr each
		...
		$( this ).find("input.renumber_oEx").attr({"name":"oEx["+e+"]"});		// 지원품목
    ...
    $(document).ready(function(){
        ...
        $("#add").click(function(){
         ...
         var html = $('<tr class="renumber_wrap">'+
            ...
            '<td><input type="text" name="oEx['+tr_n+']" class="renumber_oEx" value=""/></td>'+  
...
<form id="upForm" action="out.php" method="post">
...
<table id="input_table" class="table table-striped table-hover tbtd_caption">
    <tr>
      ...
      <th scope="row"><label for="oEx">지원품목</label></th>
   ...
   ?>
    <tr<?php echo ($i == 0 )?' id="default_form"':'';?> class="insert_form renumber_wrap">
        ...
        <td><input type='text' class="inputBox" name='oEx[<?php echo $i;?>]' class="renumber_oEx"  value="<?php echo $_POST['oEx'][$i];?>"/></td>  
...
<form action="out_update.php" method="post" id="send" name="send" class="table table-striped table-hover">
...
<table id="input_table2" class="table table-striped table-hover inTable">
   ...
   <tr>
      ...
      <td><input type='text' name='ex[]' value='<?php echo $_POST['oEx'][$i];?>' readonly /></td>
